...
BEGIN
	insert into "product_meta" ("barcode", "public_review_count", "public_total_rating") values ("new"."barcode", CASE WHEN "new"."is_private" = 0 THEN 1 ELSE 0 END, CASE WHEN "new"."is_private" = 0 THEN "new"."rating" ELSE 0 END) on conflict ("product_meta"."barcode") do update set "public_review_count" = CASE WHEN "new"."is_private" = 0 THEN "product_meta"."public_review_count" + 1 ELSE MAX(0, "product_meta"."public_review_count" - 1) END, "public_total_rating" = CASE WHEN "new"."is_private" = 0 THEN "product_meta"."public_total_rating" + "new"."rating" ELSE MAX(0, "product_meta"."public_total_rating" - "new"."rating") END;
END;