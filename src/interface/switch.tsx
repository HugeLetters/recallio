...
export const Switch = forwardRef<HTMLButtonElement, SwitchProps>(function _(props, ref) {
  return (
    <BaseSwitch.Root
      {...props}
      ref={ref}
      className="group flex w-14 shrink-0 rounded-full bg-zinc-500/20 p-1 transition focus-visible:outline-app-green-500 aria-disabled:opacity-50 data-[state=checked]:bg-app-green-500 data-[state=checked]:focus-visible:outline-app-green-900"
    >
